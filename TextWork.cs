...
namespace Notebook
{
    public static class TextWork
    {
        ...
        public static void mEditEnableds(ref TextBox notebox, ref ToolStripMenuItem mEditGiveAll, ref ToolStripMenuItem mEditCancel, ref ToolStripMenuItem mEditCopy, ref ToolStripMenuItem mEditCut, ref ToolStripMenuItem mEditDel, ref ToolStripMenuItem mEditFind, ref ToolStripMenuItem mEditGo)
        {
            if (notebox.Text.Length < 1)
            {
                mEditGiveAll.Enabled = false;
                mEditCancel.Enabled = false;
            ...
            else if (notebox.Text.Length >= 1)
            {
                mEditGiveAll.Enabled = true;
                mEditCancel.Enabled = true;
